...
* requests >=2.27.1
* pandas >=1.5.1,<2.1
* pyrodigal >=2.2.0,<=2.3.0 (for chewBBACA >=3.3.0)
...
.. important::
	...
	pip you will need to ensure that you have BLAST, MAFFT, FastTree and Prodigal (for chewBBACA <3.3.0)
	or Pyrodigal (for chewBBACA >=3.3.0) installed and added to the PATH.
