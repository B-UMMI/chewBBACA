...
def getBlastScoreRatios(genefile, basepath, doAll, verbose, blastPath):
    ...
    for allele in SeqIO.parse(genefile, "fasta", generic_dna):
        ...
        # calculate BSR for the allele
            ...
            Gene_Blast_DB_name = Create_Blastdb_no_fasta(proteinfastaPath, 1, True,alleleProt)
                    ...
                    # ~ perfectMatchIdAllele2.append(str(contigname)+"&"+str(matchLocation[0])+"-"+str(matchLocation[1])+"&"+"-")
                        ...
                        if not wasContained:
                            ...
                            if float(bestmatch[1]) >= bsrTresh and float(bestmatch[1]) < bsrTresh + 0.1:
                                ...
                                Gene_Blast_DB_name2 = Create_Blastdb_no_fasta(geneTransalatedPath2, 1, True,sequence_2_blast)
